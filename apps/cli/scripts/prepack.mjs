...
if (existsSync(backupPath)) {
  throw new Error(
    `${backupPath} already exists — a previous pack did not clean up. Restore package.json from ` +
      "it manually (or discard it if package.json is already correct) before packing again.",
  );
}
