...
function snapshot(): DashboardSnapshot {
  return {
    ...
    activeTasks: [{ taskId: "task-1", projectId: "waslo", projectName: "Waslo", title: "<img src=x onerror=alert(1)>", state: "running", complexity: "T2", risk: "medium", updatedAt: "2026-09-07T01:00:00.000Z", route: [], budget: null, approvalStatus: "pending", outcome: null, usageProvenance: [] }],
    recentTasks: [],
