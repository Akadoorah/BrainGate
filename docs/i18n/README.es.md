...
> El inglés es la fuente de verdad: [`README.md`](../../README.md). Esta traducción cubre la
...
| Google Antigravity | `agy` | solo descubrimiento; ejecución cerrada |
| xAI Grok Build | `grok` | solo descubrimiento; ejecución cerrada |
